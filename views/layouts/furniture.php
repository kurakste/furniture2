...
<?php $this->beginBody() ?>
    ...
    <!-- Mobile Nav 767px-->
        <div class="mobile-nav">
            ...
            <header class="header-area clearfix">
                ...
                <div class="cart-fav-search mb-100">
                    <a href="/cart/get-cart" class="cart-nav"><img src="/img/core-img/cart.png" alt="">  Корзина <span>(<?= $this->renderDynamic('return \app\objects\CartsBModel::getAmountItemsInCart();') ?>)</span></a>
                    ...
                    <div class="col-12 col-lg-6 col-xl-5">
                        <div class="newsletter-form mb-100">
                            <form action="/site/send-mail" method="post">
                                <input type="hidden" name="<?= $this->renderDynamic('return Yii::$app->request->csrfParam;'); ?>" value="<?= Yii::$app->request->csrfToken; ?>" />
                                <div class="input_tel">
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-126282571-1"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'UA-126282571-1');
        </script>
        ...
        <script type="text/javascript" >
            (function (d, w, c) {
                    (w[c] = w[c] || []).push(function() {
                                try {
                                                w.yaCounter50461330 = new Ya.Metrika2({
                                                    id:50461330,
                                                    clickmap:true,
                                                    trackLinks:true,
        ...
        <noscript><div><img src="https://mc.yandex.ru/watch/50461330" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
        <!-- /Yandex.Metrika counter -->
